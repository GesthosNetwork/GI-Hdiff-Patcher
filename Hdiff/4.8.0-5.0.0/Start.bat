...
:SelectionY
if not exist "Audio_Chinese_pkg_version" rd /s /q "GenshinImpact_Data\StreamingAssets\AudioAssets\Chinese" 2>nul
if not exist "Audio_English(US)_pkg_version" rd /s /q "GenshinImpact_Data\StreamingAssets\AudioAssets\English(US)" 2>nul
if not exist "Audio_Japanese_pkg_version" rd /s /q "GenshinImpact_Data\StreamingAssets\AudioAssets\Korean" 2>nul
if not exist "Audio_Korean_pkg_version" rd /s /q "GenshinImpact_Data\StreamingAssets\AudioAssets\Japanese" 2>nul
