...
if exist !A! (if not exist !AA! mkdir "!AA!" & xcopy "!A!\*" "!AA!\" /E /Y /I)
...
if "%PatchFinished%"=="True" (
  ...
  rd /s /q "GenshinImpact_Data\StreamingAssets\Audio" "GenshinImpact_Data\SDKCaches" "GenshinImpact_Data\webCaches" 2>nul
