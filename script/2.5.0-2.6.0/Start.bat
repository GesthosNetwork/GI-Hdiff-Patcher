...
if exist "GenshinImpact_Data\Persistent\AudioAssets" robocopy "GenshinImpact_Data\Persistent\AudioAssets" "GenshinImpact_Data\StreamingAssets\Audio\GeneratedSoundBanks\Windows" /e /copy:DAT /move
